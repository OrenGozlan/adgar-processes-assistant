...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "- IMPORTANT: Your response MUST end with a line containing exactly `---` followed by a suggestion to contact the right person. "
    "For example: \"Would you like to know who to contact about this?\" or \"Need help reaching the right person for this?\". "
    "This line will be displayed as a separate clickable bubble. Write it in the same language as the answer.\n"
